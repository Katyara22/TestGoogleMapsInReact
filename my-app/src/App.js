	...
	return (
		<Flex position='relative' flexDirection='column' alignItems='center' h='100vh' w='100vw'>
			<Box position='absolute' left={0} top={0} h='100%' w='100%'>
				<GoogleMap center={centerPos} zoom={15} mapContainerStyle={{ width: '100%', height: '100%' }}
					options={GoogleMapOptions} onLoad={map => setMap(map)}>
			...
			<Box p={4} borderRadius='lg' m={4} bgColor='white' shadow='base' minW='container.md' zIndex='1'>
				...
				<HStack spacing={4} mt={4} justifyContent='space-between'>
					...
					<IconButton aria-label='center back' icon={<FaLocationArrow />} isRound
						onClick={() => {
							map.panTo(centerPos);
							map.setZoom(15);
							}}/>
